...
const LoginVisual = () => {
  return (
    <div className=" w-1/2 h-full bg-gray-900 box-border rounded-lg max-mobXL:w-full max-mobXL:h-[40%] max-mobXL:bg-[url('./logo.png')] max-mobXL:max-w-sm max-mobXL:bg-white max-mobXL:bg-contain max-mobXL:bg-no-repeat max-mobXL:bg-center">
