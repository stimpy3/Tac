    ...
    <div className="relative flex flex-col">
      {modal?
         <section className='fixed z-[10] w-full h-full bg-transparent backdrop-blur-sm flex justify-center items-center'>
            ...
            <div className='absolute z-[15] opacity-[100%] w-[250px] h-[150px] bg-accentS flex flex-col justify-between rounded-xl'>
               <section className='flex items-center h-full w-fulls'>
                   <p className='text-accentTxt text-[1.2rem] text-center'>Are you sure you want to logout?</p>
               </section>
