...
const Sidebar = ({ modal, setModal }) => {
  ...
  const isActive = (path) => location.pathname === path ? "text-accent1" : "text-gray-200";
   //if isActive("/home") then path is /home

  return (
    <section className="w-[70px] h-screen bg-gray-200 pr-[15px] fixed border-box">
      <div className="flex flex-col h-full w-full bg-[#181818] shadow-lg px-[0px] py-[5px] items-center border-r-[1px] border-gray-300">
        <div
        ...
        <section className="text-gray-200 text-[1.2rem] w-full justify-center my-[15px] flex flex-col items-center">
