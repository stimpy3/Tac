...
const Sidebar = () => {
  ...
  const isActive = (path) => location.pathname === path ? "text-accent1" : "text-white";
   //if isActive("/home") then path is /home

  return (
    <section className="w-[100px] h-screen bg-gray-200 p-[15px] fixed border-box">
      <div className="flex flex-col h-full w-full bg-black rounded-lg border-[1px] border-gray-400 shadow-lg p-[5px] items-center">
        <div
