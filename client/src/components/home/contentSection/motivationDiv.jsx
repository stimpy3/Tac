...
const MotivationDiv = () => {
  ...
  return (
    <div className="h-[110px] w-full bg-gray-500 rounded-xl mb-[20px] flex items-center justify-center p-[20px] bg-[url('/topbarBG.png')] bg-cover">
      <p className="text-white text-[1.6rem] text-center select-text">{quote || "Loading quote..."}</p>
    </div>
  );
};
