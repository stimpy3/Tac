    ...
    return(
        <div className="h-screen overflow-y-auto snap-y snap-mandatory custom-scrollbar">
             <section className="parallaxSection relative h-[100vh] w-full bg-gradient-to-b from-accent0 to-gray-200 snap-start overflow-hidden flex flex-col items-center justify-end">
                    ...
                    ">
                       <button className="login bg-black text-white py-[10px] px-[5px] w-[80px] text-[1.3rem] rounded-md
                        mr-[15px] hover:translate-y-[5px] transition duration-400
                       "
                        onClick={()=>{navigate("/login");}}>Login</button>
                       <button className="signup bg-white text-black py-[9px] px-[5px] w-[80px] text-[1.3rem] rounded-md text-center
                        hover:translate-y-[5px] transition duration-400
                       "
                        onClick={()=>{navigate("/register");}}>Signup</button>
                   </div>
                    <div className="w-full h-[calc(100%-390px)] flex justify-center items-center
                     max-[575px]:mt-[62px]">
                    ...
                    min-[2201px]:text-[9rem] min-[2201px]:top-[6%] max-[2200px]:top-[4%] min-[2000px]:text-[7rem] min-[1400px]:text-[6rem]
                     max-[575px]:text-[4rem]  max-[365px]:text-[3.3rem]">Work can be <br></br> engaging and efficient</p>
                    </div>
                    <div className="phone&divs h-[350px] relative w-[557px] flex justify-center items-start  px-[10px] bottom-[-8%]
                    max-[575px]:w-[350px]  max-[365px]:w-[300px]">
                    <div className="phone absolute aspect-[1/2] w-[280px] top-[0] bg-[url('/phone.svg')] bg-contain bg-no-repeat 
                      max-[575px]:w-full"></div>
                    <div className="rightDiv flex items-end absolute w-[200px] aspect-[2/1] bg-gray-200 rounded-lg right-[10px] top-[15%] shadow-lg  border-[1px] border-gray-400
                     max-[575px]:hidden">
                    ...
                    <div className="leftDiv absolute w-[200px] aspect-[2/1] bg-gray-200 rounded-lg left-[10px] bottom-[20%] shadow-lg p-[10px] border-[1px] border-gray-400
                     max-[575px]:hidden">
